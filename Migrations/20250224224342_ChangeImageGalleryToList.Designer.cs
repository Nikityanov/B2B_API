...
namespace B2B_API.Migrations
{
    ...
    [Migration("20250224224342_ChangeImageGalleryToList")]
    partial class ChangeImageGalleryToList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("B2B_API.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("B2B_API.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("B2B_API.Models.Order", b =>
                {
                    b.HasOne("B2B_API.Models.User", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("B2B_API.Models.OrderItem", b =>
                {
                    b.HasOne("B2B_API.Models.Order", "Order")
                        .WithMany("OrderItems")
